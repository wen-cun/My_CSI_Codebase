function vsk=expe_many_peaks(vk0)
%生成指定查询波数点的傅里叶变换后多峰的光源光谱强度
...
spectrm_data=readmatrix("C:\Users\lenovo\Desktop\MATLAB\My_CSI_Codebase\Basic_Function\Source\expe_many_peaks\LightSource.txt");%读取光谱数据
